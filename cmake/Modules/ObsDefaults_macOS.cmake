...
macro(setup_obs_project)
  ...
  if(XCODE)
    ...
    # install_name_tool preserves ad-hoc signatures. See CMake Issue 21854. This
    # option is supported by codesign on macOS 11 or higher.
  ...
  # set(OBS_BUNDLE_LOCATION
  # "${OBS_OUTPUT_LOCATION}/$<CONFIG>/${OBS_BUNDLE_NAME}.app")
  # set(OBS_BUNDLE_BINARY_LOCATION "${OBS_BUNDLE_LOCATION}/Contents/MacOS")
  # set(OBS_BUNDLE_FRAMEWORK_LOCATION
  # "${OBS_BUNDLE_LOCATION}/Contents/Frameworks")
  # set(OBS_BUNDLE_RESOURCE_LOCATION
  # "${OBS_BUNDLE_LOCATION}/Contents/Resources") set(OBS_BUNDLE_PLUGIN_LOCATION
  # "${OBS_BUNDLE_LOCATION}/Contents/PlugIns")
