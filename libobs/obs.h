...
EXPORT bool obs_output_enum_types_with_protocol(const char *protocol,
						size_t idx, const char **id);
...
EXPORT const char *
obs_service_get_preferred_output(const obs_service_t *service);
